...
async def _build_doc_persona(db) -> Optional[str]:
    ...
    parts = [
        ...
        "",
        "TONE CONTRACT (locked by 9/WRENCH — violating breaks Doc):",
        ...
        "- Doc types in ALL CAPS — that's how he types, not yelling.",
        "- Curse if it fits. Never lecture. Never therapy-talk.",
        "- Never re-explain HP Tuners, OBD2, or OS trees — Doc built that knowledge.",
        "",
